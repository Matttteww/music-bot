...
REENGAGEMENT_MESSAGES: tuple[str, ...] = (
    ...
    "Шесть часов без бота — как трек без дропа. Заходи добить атмосферу.",
    "Кто-то только что выложил дебют и дрожит от первых оценок — может, ты будешь тем самым слушателем?",
    "Плейлист комьюнити не соберётся без твоего уха: открой голосование и пройдись по очереди.",
    "Хочешь цифры по своему прогрессу? В профиле всё лежит аккуратно, как метроном.",
    "Жанр не важен — от дрилла до лофи: ставят за ощущение, а не за модное слово в био.",
    "Одна ссылка SoundCloud — и твой трек уже в поле зрения тех, кто реально слушает.",
    "Лень заливать? Окей — хотя бы оцени чужое: так тоже подпитываешь сцену.",
    "Топ «сегодня» и топ «за всё время» рассказывают разные сказки — загляни к обоим.",
    "Профиль не обижается на паузы — просто покажет свежую статистику, как только зайдёшь.",
    "Стрим-очередь жива: если пропустил эфир — всё равно можно снова кинуть трек на разбор.",
    "Звёзды в избранном сами не ставятся — отметь то, что зацепило, пока не потерялось в ленте.",
    "Шкала 1–10 быстро становится привычкой, а авторам даёт понятный вектор «куда крутить микс».",
    "Не бот тебе должен — ты себе: регулярные оценки реально прокачивают слух.",
    "Кто-то в топе только потому что люди голосовали. Твой голос тоже весит.",
    "Микро-заход: меню → голосование — и ты уже влияешь на чужой день.",
    "Грустный саунд или весёлый бит — у каждого трека найдётся свой слушатель и своя оценка.",
    "Твой ник в рейтингах никуда не делся — зайди увидеть контекст и соседей по списку.",
    "Без пафоса: если скучаешь по музыке и цифрам — бот как раз про это.",
    "Голосуй честно: завышение и занижение ломают картину для всех, кто ориентируется на топ.",
    "Думаешь, все забыли твой залив? Статистика в боте скажет правду без украшений.",
    "Пара минут в боте — и вечером в наушниках уже новые имена.",
    "Корона «короля» не пылится в сейфе — конкуренция идёт, пока ты офлайн.",
    "Файлом или ссылкой — как удобнее; главное, чтобы звук дошёл до тех, кто оценит.",
    "Если личка с ботом давно пустая — нарушь тишину: треком или кругом по голосованию.",
    "Комьюнити растёт: без тебя средняя оценка и настроение ленты — не те.",
    "Бот не просит донат ради пуша — он зовёт обратно к музыке и честным баллам.",
    "Финальный аргумент: музыка, рейтинги, избранное и профиль — один тап, и ты в теме.",
    "Новый день — новые треки в очереди. Загляни, не проспи того, кто ждёт фидбек.",
    "Сравни свой средний балл с прошлым месяцем — мотивация залить что-то ещё круче.",
    "Тихий час закончился: пора снова включить бота и пусть в нём зазвучит музыка.",
)
